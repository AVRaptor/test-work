...
gulp.task('mincss', function() { // Создаем таск scss
  return gulp.src('www/scss/style.scss') // Берем источник
    .pipe(scss({outputStyle: 'compressed'})) // Преобразуем scss в CSS посредством gulp-scss
...
gulp.task('default', gulp.parallel('scss', 'mincss', 'scriptrel', 'browser-sync', 'watch'));
